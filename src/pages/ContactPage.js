            ...
            <div className={styles.contact}>  
                ...
                <div className={styles.question}>
                    <div className={styles.item}>
                        ...
                        <p>Để biết thông tin và được hỗ trợ với các câu hỏi về Fantasy League, vui lòng truy cập<a className={styles.title} href="https://www.facebook.com/10keycery">10keycery.com</a></p>
                    </div>
                </div>
                    <div className={styles.item}>
